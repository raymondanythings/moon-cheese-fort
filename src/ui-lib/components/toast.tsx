...
const ToastComponent = ({ toast, onDismiss }: ToastComponentProps) => {
	const [state, setState] = useState<"entering" | "open" | "exiting">(
		"entering",
	);
	...
	return (
		<StyledToastRoot className={classes.root} data-state={state}>
			...
			<div className="toast-content">
				<StyledToastTitle className={classes.title}>
					{toast.title}
				</StyledToastTitle>
				{toast.description && (
					<StyledToastDescription className={classes.description}>
						{toast.description}
...
export const toast = {
	success: (title: string, description?: string) => {
		if (!globalToastContext) {
			console.warn(
				"Toast context not initialized. Make sure ToastProvider is mounted.",
			);
			return "";
		}
